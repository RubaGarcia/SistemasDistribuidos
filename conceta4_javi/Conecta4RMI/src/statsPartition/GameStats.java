...
public class GameStats extends UnicastRemoteObject implements IGameStatsRemote{
	 ...
	 */     
	public GameStats (ILogService logger) throws RemoteException{
		super(PUERTO);
		this.logger = logger;
		showStatsInfo();
	}
	 ...
	 */
	synchronized public void endGame(int winnerColor) {
	 ...
	 */
	synchronized public void addPlayer(PlayerData player) {
