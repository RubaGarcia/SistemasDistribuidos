...
public class GameControl extends UnicastRemoteObject implements ActionListener, IGameControl {
     ...
     */
    public GameControl(Board board, GameStats gameStats) throws RemoteException{
    	super();
        this.board = board;
     ...
     */
    synchronized public void moveDisc (Point point, int color) {
     ...
     */
    synchronized public int registerPlayer(String name) {
     ...
     * @return the color
     */
    synchronized public int playingColor() {
	 ...
	 */
	synchronized public int getCurrentColor() {
		return board.getCurrentColor();
	}
	 ...
	 */
	synchronized public boolean isDiscMoving() {
	 ...
	 */
	synchronized public Disc getDroppingDisc() {
	 ...
	 */
	synchronized public boolean isWinnerFound() {
	 ...
	 */
	synchronized public int[][] getGameBoard() {
	 ...
	 */
	synchronized public Point[] getConnectFour() {
