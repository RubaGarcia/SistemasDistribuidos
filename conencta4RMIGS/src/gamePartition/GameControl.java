...
import common.Point;
import statsPartition.GameStats;
...
public class GameControl extends Thread implements ActionListener {
     ...
     */    
    private final IGameStats gameStats;
     ...
     */
    public GameControl(Board board, IGameStats gameStats) {
        this.board = board;
